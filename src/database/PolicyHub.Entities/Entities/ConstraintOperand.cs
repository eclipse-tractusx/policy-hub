...
{
    private ConstraintOperand()
    {
        Label = null!;
    }

    public ConstraintOperand(ConstraintOperandId constraintOperandId) : this()
    {
        Id = constraintOperandId;
        Label = constraintOperandId.ToString();
    }

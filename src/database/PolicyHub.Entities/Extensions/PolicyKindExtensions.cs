...
namespace Org.Eclipse.TractusX.PolicyHub.Entities.Extensions;

public static class PolicyKindExtensions
{
    public static bool IsTechnicalEnforced(this PolicyKindId policyKindId) =>
        policyKindId switch
        {
            PolicyKindId.BusinessPartnerNumber => true,
            PolicyKindId.Membership => true,

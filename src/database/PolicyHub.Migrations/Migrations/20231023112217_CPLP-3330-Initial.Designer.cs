...
namespace PolicyHub.Migrations.Migrations
{
    ...
    [Migration("20231023112217_CPLP-3330-Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PolicyHub.Entities.Entities.AttributeKey", b =>
                {
                    b.Property<int>("Id")
            ...
            modelBuilder.Entity("PolicyHub.Entities.Entities.Policy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PolicyHub.Entities.Entities.PolicyAssignedTypes", b =>
                {
            ...
            modelBuilder.Entity("PolicyHub.Entities.Entities.PolicyAssignedUseCases", b =>
                {
                    b.Property<Guid>("PolicyId")
                        .HasColumnType("uuid")
                        .HasColumnName("policy_id");
            ...
            modelBuilder.Entity("PolicyHub.Entities.Entities.PolicyAttribute", b =>
                {
                    b.Property<Guid>("PolicyId")
                        .HasColumnType("uuid")
                        .HasColumnName("policy_id");
            ...
            modelBuilder.Entity("PolicyHub.Entities.Entities.PolicyKind", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("PolicyHub.Entities.Entities.PolicyKindConfiguration", b =>
                {
            ...
            modelBuilder.Entity("PolicyHub.Entities.Entities.PolicyType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("PolicyHub.Entities.Entities.UseCase", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("PolicyHub.Entities.Entities.Policy", b =>
                {
                    b.HasOne("PolicyHub.Entities.Entities.AttributeKey", "AttributeKey")
                        .WithMany("Policies")
                        .HasForeignKey("AttributeKeyId")
                        .HasConstraintName("fk_policies_attribute_keys_attribute_key_id");

                    b.HasOne("PolicyHub.Entities.Entities.PolicyKind", "PolicyKind")
                        .WithMany("Policies")
            ...
            modelBuilder.Entity("PolicyHub.Entities.Entities.PolicyAssignedTypes", b =>
                {
                    b.HasOne("PolicyHub.Entities.Entities.Policy", "Policy")
                        .WithMany()
                        .HasForeignKey("PolicyId")
                        .IsRequired()
                        .HasConstraintName("fk_policy_assigned_types_policies_policy_id");

                    b.HasOne("PolicyHub.Entities.Entities.PolicyType", "PolicyType")
                        .WithMany()
            ...
            modelBuilder.Entity("PolicyHub.Entities.Entities.PolicyAssignedUseCases", b =>
                {
                    ...
                    b.HasOne("PolicyHub.Entities.Entities.UseCase", "UseCase")
                        .WithMany()
            ...
            modelBuilder.Entity("PolicyHub.Entities.Entities.PolicyKindConfiguration", b =>
                {
                    b.HasOne("PolicyHub.Entities.Entities.PolicyKind", "PolicyKind")
                        ...
                        .HasForeignKey("PolicyHub.Entities.Entities.PolicyKindConfiguration", "PolicyKindId")
                        .IsRequired()

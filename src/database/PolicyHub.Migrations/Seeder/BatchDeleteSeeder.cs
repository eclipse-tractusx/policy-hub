...
public class BatchDeleteSeeder : ICustomSeeder
{
    ...
    public async Task ExecuteAsync(CancellationToken cancellationToken)
    {
        ...
        await SeedTable<PolicyAttribute>("policy_attributes", x => x.Id, cancellationToken).ConfigureAwait(false);
        ...
        await SeedTable<PolicyAttributeAssignedUseCases>("policy_attribute_assigned_use_cases", x => new { x.AttributeId, x.UseCaseId }, cancellationToken).ConfigureAwait(false);

...
public record PolicyContentRequest(
    [property: JsonPropertyName("policyType")] PolicyTypeId PolicyType,
    [property: JsonPropertyName("constraintOperand")] ConstraintOperandId ConstraintOperand,
    [property: JsonPropertyName("constraints")] IEnumerable<Constraints> Constraints
);
